    ...
    return (
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/replacement-certificate" element={<ReplacementCertificateForm />} />
          ...
          <Route path="/apply-request-certificate" element={<ApplyRequestCertificatePage volleyballImageUrl={volleyballImageUrl} />} />
        </Routes>
      </BrowserRouter>
    );
  }
